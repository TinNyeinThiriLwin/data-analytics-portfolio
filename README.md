...
👉 [View Project](./projects/01-customer-churn-analytics)

- Identified high-risk customers using AON segmentation  
- Applied statistical testing (Z-Test) to validate churn differences  
